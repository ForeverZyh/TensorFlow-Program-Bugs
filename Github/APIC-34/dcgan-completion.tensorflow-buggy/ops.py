...
class batch_norm(object):
    ...
    def __call__(self, x, train):
        shape = x.get_shape().as_list()	+        return tf.contrib.layers.batch_norm(x, decay=self.momentum, updates_collections=None, epsilon=self.epsilon, scale=True, scope=self.name)
