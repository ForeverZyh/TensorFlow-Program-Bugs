...
subprocess.call(
    [interpreter_path, "./%s/main.py" % get_target_dir(), "--dataset=mnist", "--input_height=28", "--output_height=28",
     "--c_dim=1", "--is_train", "--checkpoint_dir=checkpoint/%s" % get_target_dir(),
     "--sample_dir=samples/%s" % get_target_dir()])
